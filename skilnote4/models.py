...
class CategoryForSkilNote4(models.Model):
    ...
    def get_absolute_url(self):
            return '/SkilNote4/myshortcut/category/{}/'.format(self.slug)

class TypeForSkilNote4(models.Model):
    type_name = models.CharField(max_length=20)

    def __str__(self):
        return self.type_name

class TempMyShortCutForSkilNote4(models.Model):
...
class TempMyShortCutForBackEndForSkilNote4(models.Model):
    title = models.CharField(max_length=120)
    content1 = models.CharField(max_length=180 , blank=True)
    content2 = models.TextField(blank=True)
    created = models.DateTimeField(auto_now_add=True , editable = False)
...
# skil note용 모델
class MyShortCutForSkilNote4(models.Model):
    title = models.CharField(max_length=120)
...
class CommentForShortCutForSkilNote4(models.Model):
    shortcut= models.ForeignKey(MyShortCutForSkilNote4, on_delete=models.CASCADE)
...
class CommentForPageForSkilNote4(models.Model):
...
class CategoryNickForSkilNote4(models.Model):
